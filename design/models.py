...
class Bid(models.Model):
    ...
    img_design = models.ImageField(upload_to='static/images/', default=None, null=True, max_length=300, verbose_name='Дизайн')
    comment = models.TextField(null=True, default=None, verbose_name='Комментарий')
