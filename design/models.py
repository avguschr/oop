...
class Bid(models.Model):
    ...
    img = models.ImageField(upload_to='static/images/', null=False, max_length=300, verbose_name='Изображение')
    img_design = models.ImageField(upload_to='static/images/', default=None, null=True, max_length=300, verbose_name='Дизайн', blank=True)
    comment = models.TextField(null=True, default=None, verbose_name='Комментарий', blank=True)
